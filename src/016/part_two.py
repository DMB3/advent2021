...
class Packet:
    ...
    def evaluate(self, data):
        ...
        results = []
        for inner in subdata:
            results.append(self.evaluate(inner))
        ...
        raise ValueError(f"Unknown type id for evaluation {type_id}")
...
if __name__ == "__main__":
    for input_file in common.inputs:
        for line in common.read_file(input_file):
            ...
            evaluation = packet.evaluate(data)
            print(f"Packet evaluation is {evaluation} for {input_file}")
